...
:官方文件: :doc:`gmt:grdinfo`
:簡介: 提取網格檔的基本信息

**grdinfo** 模塊讀取一個2D網格檔並報告網格檔的相關信息。能提取的信息包括：
...
**-I**\ [*dx*\ [/*dy*]\|\ **b**\|\ **i**\|\ **r**]
    ...
    - **-Ii** 以 **-R**\ *w/e/s/n* 輸出 **img** 補充包生成的網格檔的精確範圍
    - **-Ib** 輸出區域範圍對應的四個頂點的座標
...
**-T**\ [*dz*]\ [**+a**\ [*alpha*]]\ [**+s**]
    ...
    - **+a**\ *alpha* 對網格檔中的值進行排序，並去除極值兩端的部分數據。\ *alpha*
