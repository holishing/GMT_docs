...
- 從2D網格文件中讀入頭段信息，並使用命令行中的值替換頭段信息
- 對全球地理網格文件沿着東西方向旋轉
- 可以用 *x y z* 值替換網格文件中特定節點的值
...
**-G**\ *outgrid*
    默認情況下，\ **grdedit** 模塊會直接修改並覆蓋原始網格文件。
...
GMT 4.1.3 之前的網格文件不包含足夠的信息表明某個網格文件是地理網格。爲了添加
這一信息，可以使用::

    gmt grdedit junk.nc -fg

將網格文件 oblique.nc 逆時針旋轉90度，並輸出到新文件::
